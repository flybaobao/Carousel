$(function() {
	function C_slider(frame, list, Lframe, Llist, forwardEle, backEle, scrollType, LscrollType, acitonType, autoInterval) {
		...
		var self = this;
		$("#" + this.Llist + " > li").eq(0).addClass("visited")
		for(var i = 0; i < this.slideLength; i++) {
			...
			console.log($("#" + this.list + " li").eq(i))
			
			$("#" + this.list + " li").eq(i).css({
	...
	//实例化对象
	var goSlide1 = new C_slider("big_frame", "big_list", "small_frame", "small_list", "forward", "back", "left", "top", "click", 2000);
